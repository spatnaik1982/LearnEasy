...
const PUBLIC_ROUTES = ["/parent/login", "/parent/signup", "/calm-zone"];
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-warm-off-white">
        <div className="text-center">
          <div className="mx-auto mb-4 h-8 w-8 animate-spin rounded-full border-4 border-muted-teal border-t-transparent" />
